...
This section contains the interview question bank from `LLM_Azure_AI_Interview_700_QA.docx`, organized by topic for revision.

## Question Categories

- [Large Language Models (LLMs)](content/large-language-models.md) - 100 questions
- [Python on Azure](content/python-on-azure.md) - 100 questions
- [AI Agents & Workflow Integration](content/ai-agents-workflow-integration.md) - 100 questions
- [Microsoft Azure AI Foundry](content/microsoft-azure-ai-foundry.md) - 100 questions
