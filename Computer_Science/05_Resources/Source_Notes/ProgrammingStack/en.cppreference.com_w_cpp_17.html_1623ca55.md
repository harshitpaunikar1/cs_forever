...
Source URL: https://en.cppreference.com/w/cpp/17.html
Source Type: reference_docs
Trust Score: 90
Fetched At: 2026-04-17T07:06:46+00:00
...
[cpp](https://en.cppreference.com/cpp.html)C++17 is a major version that follows the minor version C++14 and introduces new language and library features. The standard was published in December 2017.

The following features were merged into C++17:

- From the
[File System TS](https://en.cppreference.com/experimental/fs.html): the[filesystem library](https://en.cppreference.com/filesystem.html). - From the
[Library fundamentals v1 TS](https://en.cppreference.com/experimental/memory.html): features, including[std::any](https://en.cppreference.com/utility/any.html),[std::optional](https://en.cppreference.com/utility/optional.html),[std::string_view](https://en.cppreference.com/string/basic_string_view.html),[std::apply](https://en.cppreference.com/utility/apply.html),[polymorphic allocators](https://en.cppreference.com/memory.html#Allocators),[searchers](https://en.cppreference.com/functional.html#Searchers). - From
[Library fundamentals v2 TS](https://en.cppreference.com/experimental/lib_extensions_2.html):[std::void_t](https://en.cppreference.com/types/void_t.html),[std::conjunction](https://en.cppreference.com/types/conjunction.html),[std::disjunction](https://en.cppreference.com/types/disjunction.html),[std::negation](https://en.cppreference.com/types/negation.html),[std::not_fn](https://en.cppreference.com/utility/functional/not_fn.html),[std::gcd](https://en.cppreference.com/numeric/gcd.html),[std::lcm](https://en.cppreference.com/numeric/lcm.html). - From
[Parallelism v1 TS](https://en.cppreference.com/experimental/parallelism.html): features, including[execution policies](https://en.cppreference.com/algorithm/execution_policy_tag_t.html),[std::reduce](https://en.cppreference.com/algorithm/reduce.html),[std::inclusive_scan](https://en.cppreference.com/algorithm/inclusive_scan.html),[std::exclusive_scan](https://en.cppreference.com/algorithm/exclusive_scan.html), but removing`exception_list`

. - From
[Mathematical special functions IS](https://en.cppreference.com/experimental/special_math.html):[mathematical special functions](https://en.cppreference.com/numeric/special_math.html). - From C11:
[std::aligned_alloc](https://en.cppreference.com/memory/c/aligned_alloc.html),[std::timespec_get](https://en.cppreference.com/chrono/c/timespec_get.html).

| This section is incomplete |

## Contents |

## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=1)] Obsolete features

##### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=2)] Removed features

-
[std::auto_ptr](https://en.cppreference.com/memory/auto_ptr.html), -
[deprecated function objects](https://en.cppreference.com/functional.html#Old_binders_and_adaptors), -
[std::random_shuffle](https://en.cppreference.com/algorithm/random_shuffle.html), -
[std::unexpected](https://en.cppreference.com/error/unexpected.html), - the
[obsolete](https://en.cppreference.com/io/ios_base.html#Deprecated_member_types),`iostream`

s aliases -
[trigraphs](https://en.cppreference.com/language/operator_alternative.html#Trigraphs_.28removed_in_C.2B.2B17.29), - the
keyword,`register` -
,`bool`

increment -
[dynamic exception specification](https://en.cppreference.com/language/except_spec.html)

##### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=3)] Deprecated features

-
[std::iterator](https://en.cppreference.com/iterator/iterator.html), -
[std::raw_storage_iterator](https://en.cppreference.com/memory/raw_storage_iterator.html), -
[std::get_temporary_buffer](https://en.cppreference.com/memory/get_temporary_buffer.html), -
[std::is_literal_type](https://en.cppreference.com/types/is_literal_type.html), -
[std::result_of](https://en.cppreference.com/types/result_of.html), - all of
`<codecvt>`

## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=4)] New language features

-
`u8`

character literal - made
part of type system`noexcept` - new
[order of evaluation](https://en.cppreference.com/language/eval_order.html)rules -
[lambda capture of *this](https://en.cppreference.com/language/lambda.html#Lambda_capture)

-
`constexpr`- compile-time
`if constexpr` -
[constexpr lambda](https://en.cppreference.com/language/lambda.html)

- compile-time

-
**Variables**-
[inline variables](https://en.cppreference.com/language/inline.html) -
[structured bindings](https://en.cppreference.com/language/structured_binding.html) - initializers for
and`if``switch` - guaranteed
[copy elision](https://en.cppreference.com/language/copy_elision.html) -
[temporary materialization](https://en.cppreference.com/language/implicit_cast.html#Temporary_materialization)

-

-
**Templates**-
[fold-expressions](https://en.cppreference.com/language/fold.html)( ... ) -
[class template argument deduction](https://en.cppreference.com/language/ctad.html)tuple t(4, 3, 2.5) - constant
[template parameters](https://en.cppreference.com/language/template_parameters.html)declared with`auto`

-

-
[Namespaces](https://en.cppreference.com/language/namespace.html)- simplified nested namespaces
-
`using`

-declaration declaring multiple names -
[attribute namespaces](https://en.cppreference.com/language/attributes.html)don't have to repeat

-
**new**:[attributes](https://en.cppreference.com/language/attributes.html)-
`[[`

[fallthrough](https://en.cppreference.com/language/attributes/fallthrough.html)]] -
`[[`

[maybe_unused](https://en.cppreference.com/language/attributes/maybe_unused.html)]] -
`[[`

[nodiscard](https://en.cppreference.com/language/attributes/nodiscard.html)]]

-
-
`__has_include`

## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=5)] New headers

## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=6)] New library features

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=7)] Utility types

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=8)] Memory management

- uninitialized memory algorithms
-
`weak_from_this` -
[std::pmr::memory_resource](https://en.cppreference.com/memory/memory_resource.html)and[std::polymorphic_allocator](https://en.cppreference.com/memory/polymorphic_allocator.html) -
[std::aligned_alloc](https://en.cppreference.com/memory/c/aligned_alloc.html) - transparent
[std::owner_less](https://en.cppreference.com/memory/owner_less.html) - array support for
[std::shared_ptr](https://en.cppreference.com/memory/shared_ptr.html) -
[allocation functions](https://en.cppreference.com/memory/new/operator_new.html)with explicit alignment

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=9)] Compile-time programming

-
`std::byte` -
[std::conjunction](https://en.cppreference.com/types/conjunction.html)/[std::disjunction](https://en.cppreference.com/types/disjunction.html)/[std::negation](https://en.cppreference.com/types/negation.html) -
[type trait](https://en.cppreference.com/utility/rtti.html)variable templates (

)*xxx*_+v -
[std::is_swappable](https://en.cppreference.com/types/is_swappable.html) -
`std::is_invocable` -
`std::is_aggregate` -
[std::has_unique_object_representations](https://en.cppreference.com/types/has_unique_object_representations.html)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=10)] Algorithms

-
[std::clamp](https://en.cppreference.com/algorithm/clamp.html) - parallel algorithms and
[execution policies](https://en.cppreference.com/algorithm/execution_policy_tag_t.html) -
[std::inclusive_scan](https://en.cppreference.com/algorithm/inclusive_scan.html) -
[std::exclusive_scan](https://en.cppreference.com/algorithm/exclusive_scan.html) -
[std::gcd](https://en.cppreference.com/numeric/gcd.html) -
[std::lcm](https://en.cppreference.com/numeric/lcm.html) -
[std::reduce](https://en.cppreference.com/algorithm/reduce.html)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=11)] Iterators and containers

- map/set
and map/set`extract``merge` - map/unordered_map
and`try_emplace``insert_or_assign` - contiguous iterators (
[LegacyContiguousIterator](https://en.cppreference.com/named_req/ContiguousIterator.html)) - non-member
[std::size](https://en.cppreference.com/iterator/size.html)/[std::empty](https://en.cppreference.com/iterator/empty.html)/[std::data](https://en.cppreference.com/iterator/data.html)

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=12)] Numerics

### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=13)] Others

-
[cache line interface](https://en.cppreference.com/thread/hardware_destructive_interference_size.html) -
[std::launder](https://en.cppreference.com/utility/launder.html) -
[std::uncaught_exceptions](https://en.cppreference.com/error/exception/uncaught_exception.html) -
/`std::to_chars``std::from_chars` -
`std::atomic<T>::is_always_lock_free` -
`std::scoped_lock` -
[std::timespec_get](https://en.cppreference.com/chrono/c/timespec_get.html) - rounding functions for
[std::chrono::duration](https://en.cppreference.com/chrono/duration.html)and[std::chrono::time_point](https://en.cppreference.com/chrono/time_point.html)

## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=14)] Defect reports

## [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=15)] Compiler support
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=cpp/17&action=edit§ion=16)] External links
