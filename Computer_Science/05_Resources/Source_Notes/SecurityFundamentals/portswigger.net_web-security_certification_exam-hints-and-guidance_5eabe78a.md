Title: Hints and guidance for the Burp Suite Certified Practitioner exam | Web Security Academy - PortSwigger
Mapped Topic: Practical web security labs and notes
Source URL: https://portswigger.net/web-security/certification/exam-hints-and-guidance
Source Type: official_training
Trust Score: 96
Fetched At: 2026-04-17T07:12:48+00:00
Mapped From CSE.md Section: Part 2: H. Security fundamentals

# Content

Ready to take the exam?
[Here's what you need to know.](https://portswigger.net/web-security/certification/how-it-works#what-the-exam-involves)
...
Scanning selected pages and insertion points with Burp Suite Professional will often help you quickly progress through the exam. Attempting a full application scan will not be feasible in the exam time frame. Some vulnerabilities are are very challenging to detect using only manual testing. If you get stuck, we highly recommend using Burp Scanner to help you tackle the problem.

We've created a guide to [using Burp Scanner during manual testing](https://portswigger.net/web-security/essential-skills/using-burp-scanner-during-manual-testing), to make sure you've got
...
your attack methods to bypass broken defenses](https://portswigger.net/web-security/essential-skills/obfuscating-attacks-using-encodings) - specifically - obfuscating attacks using encodings.

The victim user is running Chromium. When using the [XSS Cheat Sheet](https://portswigger.net/web-security/cross-site-scripting/cheat-sheet), focus on vectors that work on Chrome. If your XSS
attack works in Burp's browser or Chrome, chances are it'll work on the victim.

Burp Suite Professional provides the essential functionality to solve the exam. Some vulnerabilities are easier to solve with the following third party tools: [ysoserial](https://github.com/frohoff/ysoserial)
and [HTTP Request Smuggler](https://github.com/PortSwigger/http-request-smuggler). These tools are used by certain labs at the "Practitioner" level. We recommend caution when using other tools - they may
turn out not to be suitable for your objective.
...
[the skill set the certification aims to prove](https://portswigger.net/web-security/certification#what-does-a-burp-suite-certification-mean-for-me).
