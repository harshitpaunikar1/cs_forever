Title: What is path traversal, and how to prevent it? | Web Security Academy
Mapped Topic: Practical web security labs and notes
Source URL: https://portswigger.net/web-security/file-path-traversal
Source Type: official_training
Trust Score: 96
Fetched At: 2026-04-17T07:13:02+00:00
...
parameter and returns the contents of the specified file. The image files are stored on disk in the location `/var/www/images/`
...
In some contexts, such as in a URL path or the `filename`

parameter of a `multipart/form-data`
