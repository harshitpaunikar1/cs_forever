...
Source URL: https://portswigger.net/web-security/dom-based
Source Type: official_training
Trust Score: 96
Fetched At: 2026-04-17T07:13:01+00:00
...
[Reflected data](https://portswigger.net/web-security/cross-site-scripting/dom-based#dom-xss-combined-with-reflected-and-stored-data)LABS[Stored data](https://portswigger.net/web-security/cross-site-scripting/dom-based#dom-xss-combined-with-reflected-and-stored-data)LABS[Web messages](https://portswigger.net/web-security/dom-based/controlling-the-web-message-source)LABS
