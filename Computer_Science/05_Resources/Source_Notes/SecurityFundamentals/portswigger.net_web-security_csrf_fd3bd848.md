Title: What is CSRF (Cross-site request forgery)? Tutorial & Examples | Web Security Academy
Mapped Topic: Practical web security labs and notes
Source URL: https://portswigger.net/web-security/csrf
Source Type: official_training
Trust Score: 96
Fetched At: 2026-04-17T07:12:58+00:00
...
[SameSite cookies](https://portswigger.net/web-security/csrf#common-defences-against-csrf)are not being used). - The vulnerable website will process the request in the normal way, treat it as having been made by the victim user, and change their email address.
