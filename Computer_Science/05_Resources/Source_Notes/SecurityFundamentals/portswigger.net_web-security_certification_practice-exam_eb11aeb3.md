Title: Practice Exam - Burp Suite Certified Practitioner | Web Security Academy - PortSwigger
Mapped Topic: Practical web security labs and notes
Source URL: https://portswigger.net/web-security/certification/practice-exam
...
Capably perform the exploits outlined within the

[exploiting XSS labs](https://portswigger.net/web-security/cross-site-scripting/exploiting), in the[XSS topic](https://portswigger.net/web-security/cross-site-scripting).Have a go at solving labs generated by the mystery lab challenge.
...
to grips with the full scope of scanning you'll need to perform during the exam. The exam also requires you to be able to [
adapt your attack methods to bypass broken defenses](https://portswigger.net/web-security/essential-skills/obfuscating-attacks-using-encodings) - specifically - obfuscating attacks using encodings.
...
. If you can enumerate usernames, you may also be able to brute-force the login using the following
