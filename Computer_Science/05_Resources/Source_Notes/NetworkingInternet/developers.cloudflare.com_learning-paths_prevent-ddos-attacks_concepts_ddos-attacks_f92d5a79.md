Title: What is a DDoS attack? Â· Cloudflare Learning Paths
Mapped Topic: DNS, CDN, DDoS, reverse proxy, load balancing
Source URL: https://developers.cloudflare.com/learning-paths/prevent-ddos-attacks/concepts/ddos-attacks/
...
For more resources on DDoS attacks and how they work, refer to our [Learning Center â](https://www.cloudflare.com/learning/ddos/what-is-a-ddos-attack/).
