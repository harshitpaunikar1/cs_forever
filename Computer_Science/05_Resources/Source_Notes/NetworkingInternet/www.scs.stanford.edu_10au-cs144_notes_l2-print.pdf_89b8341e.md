...
Source URL: https://www.scs.stanford.edu/10au-cs144/notes/l2-print.pdf
Source Type: university_course_notes
Trust Score: 95
Fetched At: 2026-04-17T06:59:09+00:00
...
• 2007: Comcast forges RST s to BitT orrent
...
• T elnet client is a text interface
...
to collaborate with
BitT orrent
• T orrent ﬁle ( .torrent ) describes ﬁle to download
...
• BitT orrent breaks up a ﬁle into N pieces
...
from multiple peers
BitT orrent Communication
BitTyrant [Piatek]
• Optional reading: 2007 research paper
• T ake advantage of altriusm
...
BitT orrent T oday: Engineering (IETF)
...
• Application Layer T ransport Optimization (alto)
• Low Extra Delay Background T ransport (ledbat)
