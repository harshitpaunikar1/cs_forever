...
Source URL: https://hpbn.co/mobile-networks/
Source Type: open_book
Trust Score: 93
Fetched At: 2026-04-17T06:59:35+00:00
...
[§](https://hpbn.co#brief-history-of-the-gs)Brief History of the G’s

Navigating the forest of the various cellular standards, release
...
major past and future milestones ([Table 7-1](https://hpbn.co#wireless-history)) of the dominant wireless
...
2G
Kbit/s
First digital systems as overlays or parallel to analog
systems
3G
Mbit/s
Dedicated digital networks deployed in parallel to analog
systems
4G
Gbit/s
Digital and packet-only networks

The first important realization is that the underlying standards for
each wireless generation are expressed in terms of *peak spectral
efficiency* (bps/Hz), which is then translated to impressive numbers
such as Gbit/s+ peak data rates for 4G networks. However, you should now
recognize the key word in the previous sentence: *peak!* Think
back to our earlier discussion on [
Measuring Real-World Wireless Performance](https://hpbn.co/introduction-to-wireless-networks/#measuring-real-world-wireless-performance)—peak data rates are
achieved in ideal conditions.

Regardless of the standard, the real performance of every network will
...
strategy to calibrate your performance expectations ([Table 7-2](https://hpbn.co#cellular-performance)) is to assume much closer
...
To complicate matters further, the classification of any given network
...
their evolution.
The first commercial 1G network was launched in Japan in 1979. It
...
rate of 9.6 Kbit/s!
It wasn’t until the mid 1990s, when general packet radio service
...
At this point, a pause and some reflection is warranted. Wireless
...
Once the consumer demand for wireless data services began to grow,
...
In response, the European Telecommunication Standards Institute
...
( In 1998, recognizing the need for global evolution of the deployed
...
Responsible for developing the 3G specifications based on the
CDMA2000 technology, which is a successor to the IS-95 standard
developed by Qualcomm.
Consequently, the development of both types of standards
( Chances are, you should see some familiar labels on the list: EV-DO,
...
industry:
There are two dominant, deployed mobile network types around the
world.
3GPP and 3GPP2 manage the evolution of each technology.
3GPP and 3GPP2 standards are not device interoperable.
There is no one 4G or 3G technology. The International
...
In the context of 3G networks, we have two dominant and competing
...
standards ( Why couldn’t we simply jump to 4G instead? Well, standards take a
...
Not surprisingly, the throughput, latency, and other performance
...
In the case of networks following the 3GPP standards, the
...
From there, the next upgrade was HSPA+ (3.75G), which offered
...
LTE-Advanced!
The CDMA2000 EV-DO standard developed by 3GPP2 followed a similar
...
The Rev. C release is also frequently referred to as EV-DO
...
to the standards generation table ( While 3GPP2 could have continued to evolve its CDMA technologies,
at some point both the network operators and the network vendors
agreed on 3GPP LTE as a In other words, most mobile operators around the world are
...
3G is often described as "mobile broadband." However, broadband
...
use.
Before we dissect the various 4G technologies, it is important to
...
100 Mbit/s data rate for mobile clients and Gbit/s+ when
stationary
Sub 100 ms control-plane latency and sub 10 ms user-plane
latency
Dynamic allocation and sharing of network resources between
users
Use of variable bandwidth allocation, from 5 to 20 MHz
The actual list is much, much longer but the preceding captures the
...
LTE-Advanced is a standard that was specifically developed to
...
there, but not quite!
However, this is where the marketing steps in. The 3G and 4G
...
a set of technologies that are What about the real (LTE-Advanced) 4G deployments? Those are coming,
...
Despite the continuous evolution of the 3G standards, the increased
...
Low latencies in user (<10 ms) and control planes (<100
ms)
New radio interface and modulation for high throughput (100
Mbps)
Ability to use larger bandwidth allocations and carrier
aggregation
MIMO as a requirement for all devices
Not surprisingly, the preceding list should read similar to the
...
At this point it is important to note that due to radio and core
...
Finally, as the name implies, LTE is definitely the long-term
...
quickly?
HSPA+ was first introduced in 3GPP release 7, back in 2007. However,
...
that it is 3GPP 3G technologies command the lion’s share of the established
...
performance.
Cost-effectiveness is the name of the game and the reason why
current industry projections ( For a variety of reasons, North America appears to be the leader in
...
By extension, it is a fairly safe bet that we will be talking
...
proposition.
Crystal ball gazing is a dangerous practice in our industry.
...
time.
First, the wireless standards are evolving quickly, but the physical
...
accordingly.
Ironically, while 4G networks provide significant improvements for
...
Consequently, when building applications for mobile networks, we
...
The good news is HSPA+ and LTE adoption is growing very fast, which
...
throughput and latency ( However, while 4G wireless performance is often compared to that of
...
definitely not.
For example, most users and developers expect an "always on"
...
[§](https://hpbn.co#first-data-services-with-2g)First Data Services
with 2G[§](https://hpbn.co#3gpp-and-3gpp2-partnerships)3GPP and 3GPP2
Partnerships[Figure 7-1](https://hpbn.co#mobile-technologies)).
...
[Table 7-3](https://hpbn.co#cellular-standards)) and
...
UMTS
3GPP2
CDMA 2000 1x EV-DO Release 0
3.5G, 3.75G, 3.9G
3GPP
HSPA, HSPA+, LTE
3GPP2
EV-DO Revision A, EV-DO Revision B, EV-DO Advanced
4G
3GPP
LTE-Advanced, HSPA+ Revision 11+

`*#*#4636#*#*`

. If your phone allows it, it should open a
diagnostics screen where you can inspect the status and type of your
mobile connection, battery diagnostics, and more.
[§](https://hpbn.co#evolution-of-3g-technologies)Evolution of 3G
Technologies[Table 7-3](https://hpbn.co#cellular-standards)) shows, each is also split
...
4
2001
Introduced an all-IP core network
5
2002
Introduced High-Speed Packet Downlink Access (HSDPA)
6
2004
Introduced High-Speed Packet Uplink Access (HSUPA)
7
2007
Introduced High-Speed Packet Access Evolution (HSPA+)
8
2008
Introduced new LTE System Architecture Evolution (SAE)
9
2009
Improvements to SAE and WiMAX interoperability
10
2010
Introduced 4G LTE-Advanced architecture
...
Rel. 0
1999
First release of the 1x EV-DO standard
Rev. A
2001
Upgrade to peak data-rate, lower latency, and QoS
Rev. B
2004
Introduced multicarrier capabilities to Rev. A
Rev. C
2007
Improved core network efficiency and performance
[Table 7-3](https://hpbn.co#cellular-standards)), you may have noticed that
3GPP2 does not have an official and competing 4G standard!
*common 4G successor* to all types of
...
[§](https://hpbn.co#imt-advanced-4g-requirements)IMT-Advanced 4G
Requirements

*significantly close* to the 4G
...
marketed as "4G."
[§](https://hpbn.co#long-term-evolution-lte)Long Term Evolution (LTE)

*long-term one*—perhaps over the course of the next decade or
so. In the meantime, HSPA+ is set to take the center stage.
[§](https://hpbn.co#hspa-is-leading-worldwide-4g-adoption)HSPA+ is
Leading Worldwide 4G Adoption*the standard* for future mobile networks, why
continue to develop and invest into HSPA+? As usual, the answer is a
simple one: cost.
[Figure 7-2](https://hpbn.co#growth-4g)) show HSPA+ as responsible for the
...
[Figure 7-3](https://hpbn.co#growth-4g-na)).
...
[§](https://hpbn.co#building-for-the-multigeneration-future)Building
for the Multigeneration Future[Table 7-6](https://hpbn.co#hspa-to-lte-advanced)): mid to high digit Mbps
...
LTE
LTE-Advanced
Peak downlink speed (Mbit/s)
168
300
3,000
Peak uplink speed (Mbit/s)
22
75
1,500
Maximum MIMO streams
2
4
8
Idle to connected latency (ms)
< 100
< 100
< 50
Dormant to active latency (ms)
< 50
< 50
< 10
User-plane one-way latency (ms)
< 10
< 5
< 5

[§](https://hpbn.co#device-features-and-capabilities)Device Features
and Capabilities
...
However, even with all of these variables accounted for, when it comes
...
Both the 3GPP and 3GPP2 standards continue to evolve and enhance the
...
performance.
An obvious and important question is, why? Once again, the answer is
...
The HSPA standard alone specifies over 36 possible UE categories!
Hence, just saying that you have an "HSPA capable device"
( Similarly, the LTE standard defines its own set of user equipment
categories ( In practice, most of the early LTE deployments are targeting
category 1–3 devices, with early LTE-Advanced networks focusing on
category 3 as their primary UE type.
If you own an LTE or an HSPA+ device, do you know its category
...
[§](https://hpbn.co#user-equipment-category)User Equipment Category[Table 7-7](https://hpbn.co#hspa-ue)) is not
...
Quad-cell + MIMO
168.8
[Table 7-8](https://hpbn.co#lte-ue)): a
...
[§](https://hpbn.co#radio-resource-controller-rrc)Radio Resource
Controller (RRC)

Both 3G and 4G networks have a unique feature that is not present in
...
radio base station ([Figure 7-4](https://hpbn.co#rrc-diagram)). Understanding why it exists, and how
...
When using a physical connection, such as an Ethernet cable, your
...
best possible case for minimizing latency. As we saw in [From Ethernet to a
Wireless LAN](https://hpbn.co/wifi/#from-ethernet-to-a-wireless-lan), the WiFi standard follows a similar model, where each
...
[§](https://hpbn.co#3g-4g-and-wifi-power-requirements)3G, 4G, and
...
So how does the battery and power management affect networking
performance? Signal power (explained [Signal Power](https://hpbn.co/introduction-to-wireless-networks/#signal-power)) is one of the primary levers to
...
[§](https://hpbn.co#lte-rrc-state-machine)LTE RRC State Machine

The radio state of every LTE device is controlled by the radio tower
...
of each device connected to the network ([Figure 7-5](https://hpbn.co#lte-rrc-diagram)). The network operator can make
...
IP traffic is bursty, optimized TCP connections are long-lived, and
...
covered [Connection-State Timeouts](https://hpbn.co/building-blocks-of-udp/#connection-state-timeouts), the RRC state
machine depends on a collection of timers to trigger the RRC state
transitions.

Finally, because the connected state requires such high amounts of
power, multiple sub-states are available ([Figure 7-5](https://hpbn.co#lte-rrc-diagram)) to allow for more efficient
operation:
...
If the radio remains idle long enough, it is then transitioned to
...
listen to the broadcasts ([Figure 7-6](https://hpbn.co#drx)).
...
So what does this all mean in practice? Depending on which power
state the radio is in, an LTE device may first require anywhere from 10
to 100 milliseconds ([Table 7-9](https://hpbn.co#lte-rrc-latency)) of latency to negotiate the
...
[§](https://hpbn.co#hspa-and-hspa-umts-rrc-state-machine)HSPA and
HSPA+ (UMTS) RRC State Machine

Earlier generation 3GPP networks prior to LTE and LTE-Advanced have
...
earlier generations is a bit more complicated ([Figure 7-7](https://hpbn.co#umts-rrc)), and the latencies are much, much
...
- Cell FACH
-
An intermediate power state, which consumes significantly less power than DCH. The device does not have dedicated network resources but is nonetheless able to transmit small amounts of user data through a shared low-speed channel (with speeds of typically less than 20 Kbps).
...
The good news is the latest HSPA+ networks have made significant
improvements in this department and are now competitive with LTE
([Table 7-6](https://hpbn.co#hspa-to-lte-advanced)).
...
[§](https://hpbn.co#ev-do-cdma-rrc-state-machine)EV-DO (CDMA) RRC
State Machine
...
Not surprisingly, regardless of the differences in the standards,
...
([Figure 7-8](https://hpbn.co#cdma-rrc)), which
...
[§](https://hpbn.co#inefficiency-of-periodic-transfers)Inefficiency
...
Every radio transmission, no matter how small, forces a transition
...
expired ([Figure 7-9](https://hpbn.co#energy-tail)).
...
[§](https://hpbn.co#end-to-end-carrier-architecture)End-to-End Carrier
Architecture
...
Why LTE? First, it is the most likely architecture for new carrier
...
The radio access network (RAN) is the first big logical component of
every carrier network ( Whenever a user has a stronger signal from a nearby cell, or if his
...
First of all, if the user’s device can be associated with any radio
...
to several seconds.
However, we’re not done yet. Radio handoffs can be a frequent
...
The core network must know the location of the user, but frequently
...
The core network ( First, we have the packet gateway (PGW), which is the public gateway
...
Each device within the carrier network has an internal identifier,
...
The PGW also performs all the common policy enforcement, such as
...
The PGW routes all of its packets to the SGW. However, to make
...
Hence, when a packet arrives at the SGW, a query to the MME is sent
...
network.
In a nutshell, that is all there is to it. This high-level
...
following workflow:
Data arrives at the external packet gateway, which connects the
core network to the public Internet.
A set of routing and packet policies is applied at the packet
gateway.
Data is routed from the public gateway to one or more serving
gateways, which act as mobility anchors for the devices within the
radio network.
A user database service performs the authentication, billing,
provisioning of services, and location tracking of each user on the
network.
Once the location of the user within the radio network is
determined, the data is routed from the serving gateway to the
appropriate radio tower.
The radio tower performs the necessary resource assignment and
negotiation with the target device and then delivers the data over
the radio interface.
An important factor in the performance of any carrier network is the
...
Delivering a true 4G experience is not a simple matter of deploying
...
network.
In practice, a single radio tower may serve up to three nearby
...
Needless to say, all of these requirements make 4G networks a costly
...
network.
These performance bottlenecks are not something we can control as
...
our earlier discussion on Just because you are connected over a 4G interface doesn’t mean you
...
[§](https://hpbn.co#radio-access-network-ran)Radio Access Network (RAN)[Figure 7-10](https://hpbn.co#lte-ran-network)), whose primary responsibility
...
[§](https://hpbn.co#core-network-cn)Core Network (CN)[Figure 7-11](https://hpbn.co#lte-core-network)), which is also known as the
...
[§](https://hpbn.co#backhaul-capacity-and-latency)Backhaul Capacity
and Latency[Last-Mile
Latency](https://hpbn.co/primer-on-latency-and-bandwidth/#last-mile-latency) in wired networks.

[§](https://hpbn.co#packet-flow-in-a-mobile-network)Packet Flow in a
Mobile Network

One of the primary complaints about designing applications for the
...
predictable!
To start, let’s assume that the user has already authenticated with
a 4G network and the mobile device is idle. Next, the user types in a
URL and hits "Go." What happens next?
First, because the phone is in idle RRC state, the radio must
synchronize with the nearby radio tower and send a request for a new
radio context to be established ( Once the radio context is established, the device has a resource
...
high-power state.
However, we are not done yet, as we have only transferred our
...
carrier.
Next, let’s say the browser has fetched the requested page and the
...
a DRX state ( Nearly the same workflow is repeated as we just saw, except that
because the device was in a dormant (DRX) state, a slightly quicker
negotiation ( In summary, a user initiating a new request incurs several different
latencies:
Fixed, one-time latency cost incurred for RRC negotiation and
state transitions: <100 ms for idle to active, and <50 ms for
dormant to active.
Fixed cost for every application packet transferred between the
device and the radio tower: <5 ms.
Carrier dependent cost for transporting the packet from the
radio tower to the packet gateway: in practice, 30–100 ms.
Variable latency cost between the carrier’s packet gateway and
the destination address on the public Internet.
The first two latencies are bounded by the 4G requirements, the core
...
the user; see the earlier discussion on Now let’s examine the opposite scenario: the user’s device is idle,
but a data packet must be routed from the PGW to the user
( As we saw earlier, the PGW routes the inbound packet to the SGW
...
MME.
Instead, if the device is idle, the MME sends a paging message (step
...
context.
Once the radio context is established, the tower that performed the
...
Once the device is in a connected state, a direct tunnel is
...
it.
The preceding packet workflow is transparent to IP and all layers
...
[§](https://hpbn.co#initiating-a-request)Initiating a Request[Figure 7-12](https://hpbn.co#lte-request), step 1)—this negotiation requires
...
[LTE RRC
State Machine](https://hpbn.co#lte-rrc-state-machine)) to conserve battery power and to free up network
...
[Figure 7-12](https://hpbn.co#lte-request), step 1) can take place between the
device and the radio tower—up to 50 milliseconds ([Table 7-9](https://hpbn.co#lte-rrc-latency)) for dormant to connected.
...
[§](https://hpbn.co#inbound-data-flow)Inbound Data Flow[Figure 7-13](https://hpbn.co#lte-notification)).
...
[§](https://hpbn.co#heterogeneous-networks-hetnets)Heterogeneous
Networks (HetNets)
...
The core idea behind HetNets is a simple one: instead of relying on
...
cells ([Figure 7-14](https://hpbn.co#hetnet)), each of
...
[§](https://hpbn.co#real-world-3g-4g-and-wifi-performance)Real-World
...
As a concrete example, a joint research project between the University
of Michigan and AT&T Labs ran a country-wide test ([Figure 7-16](https://hpbn.co#mobiperf)) within the U.S., comparing
4G, 3G, and WiFi (802.11g, 2.4GHz) performance:

-
Performance measurements were done against 46 distinct Measurement Lab nodes, which is an open platform for Internet measurement tools, and via the MobiPerf open-source measurement client.
...
For full details of the 4G performance study, analysis, and conclusions, refer to "A Close Examination of Performance and Power Characteristics of 4G LTE Networks" presented at MobiSys 2012.
