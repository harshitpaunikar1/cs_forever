...
Source URL: https://www.scs.stanford.edu/10au-cs144/notes/l14-print.pdf
Source Type: university_course_notes
Trust Score: 95
Fetched At: 2026-04-17T06:57:26+00:00
...
• V ery poor assumption to make when bad guys can
control network!
LAN Eavesdropping
...
• T oday still the case with 802.11b
...
- Server has connection w. same ports, different SACK
...
- Drives up CACK and SACK so out of range
...
- NA V (Net Allocation V ector) used to suggest when network
