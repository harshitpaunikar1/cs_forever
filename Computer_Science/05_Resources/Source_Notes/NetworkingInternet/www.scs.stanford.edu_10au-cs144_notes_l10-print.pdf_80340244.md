...
Source URL: https://www.scs.stanford.edu/10au-cs144/notes/l10-print.pdf
Source Type: university_course_notes
Trust Score: 95
Fetched At: 2026-04-17T06:56:33+00:00
Mapped From CSE.md Section: Part 1 / Part 2.B

# Content

Lecture 10: TCP Friendliness, DCCP , NAT s,
and STUN TCP Friendliness
Congestion Control
...
- After cwnd
R2−R lossless congestion windows, decrement R
CCID 3
...
• IETF Standards T rack
• Well suited to V oIP , Internet Gaming, etc.
• Sees very little use
2-minute stretch

Network Address T ranslator
NAT
• Network Address T ranslator
NAT
(128.34.22.8)
...
• T eminology is imperfect (static port mappings,
etc.)
...
Simple T raversal of UDP through NAT s
STUN (RFC 3849)
• “Simple T raversal of User Datagram Protocol
(UDP) Through Network Address T ranslators
(NAT s)”
• Enables a node to
...
- A tries to send UDP packets to (LB, G B) using LA
- B tries to send UDP packets to (LA, G A) using LB
