...
Source URL: https://www.scs.stanford.edu/10au-cs144/notes/l1-print.pdf
Source Type: university_course_notes
Trust Score: 95
Fetched At: 2026-04-17T06:56:09+00:00
...
Networks class
• Goal: T each the concepts underlying networks
...
• T ext: Kurose & Ross, Computer Networking: A
...
Educational Change
Dominance in T echnology T oday
It Hasn’t Stopped
...
• T ransport protocols: TCP and UDP
...
• Next lecture: applications (HTTP , BitT orrent, etc.)
...
- V ery easy to innovate and develop new uses of network
...
• T o scale to more nodes, use switching
...
• T ransport – demultiplexes, provides reliability &
ﬂow control (3, 4)
...
• Goodput – T ransferSize /Latency
• Jitter – V ariation in latency
