...
Trust Score: 96
Fetched At: 2026-04-17T07:09:41+00:00
...
A new minor release, [FFmpeg 8.1 "Hoare"](https://ffmpeg.org/download.html#release_8.1),
...
A new major release, [FFmpeg 8.0 "Huffman"](https://ffmpeg.org/download.html#release_8.0),
...
### September 30th, 2024, FFmpeg 7.1 "PÃ©ter"

[FFmpeg 7.1 "PÃ©ter"](https://ffmpeg.org/download.html#release_7.1), a new
major release, is now available! A full list of changes can be found in the release
[changelog](https://git.ffmpeg.org/gitweb/ffmpeg.git/blob/refs/heads/release/7.1:/Changelog).
...
A new major release, [FFmpeg 7.0 "Dijkstra"](https://ffmpeg.org/download.html#release_7.0),
is now available for download. The most noteworthy changes for most users are
a [native VVC decoder](https://ffmpeg.org#vvcdec) (currently experimental, until more
fuzzing is done), [IAMF support](https://ffmpeg.org#iamf), or a
[multi-threaded ffmpeg CLI tool](https://ffmpeg.org#cli_threading).
...
channel layout API, replaced by the `AVChannelLayout`
...
and countless smaller features and bugfixes. Compared to 6.1, the `git`
...
library can now read and write [IAMF](https://aomediacodec.github.io/iamf/)
(Immersive Audio) files. The `ffmpeg`
...
### December 12th, 2023, multi-threaded `ffmpeg`

CLI tool

Thanks to a major refactoring of the `ffmpeg`
...
[FFmpeg 6.1 "Heaviside"](https://ffmpeg.org/download.html#release_6.1), a new
...
[repository](https://git.videolan.org/?p=ffmpeg.git;a=summary) is required.
...
A new major release, [FFmpeg 6.0 "Von Neumann"](https://ffmpeg.org/download.html#release_6.0),
...
[FFmpeg 5.1 "Riemann"](https://ffmpeg.org/download.html#release_5.1), a new
major release, is now available! Some of the highlights:
...
[FFmpeg 5.0 "Lorentz"](https://ffmpeg.org/download.html#release_5.0), a new
...
now! Feel free to join us at #ffmpeg and #ffmpeg-devel. More info at [contact#IRCChannels](https://ffmpeg.org/contact.html#IRCChannels)

### April 8th, 2021, FFmpeg 4.4 "Rao"

[FFmpeg 4.4 "Rao"](https://ffmpeg.org/download.html#release_4.4), a new
major release, is now available! Some of the highlights:
...
[FFmpeg 4.3 "4:3"](https://ffmpeg.org/download.html#release_4.3), a new
major release, is now available! Some of the highlights:
...
[Incredibles 2 Screen Slaver](https://www.youtube.com/watch?v=8L_9hXnUzRk)
scene. It is not perfect. If you have other clips that you want this filter to
work better on, please report them to us on our [trac](http://trac.ffmpeg.org).

[See for yourself](http://ffmpeg.org/~compn/output20p8.mp4).
...
or find another use for this, [please let me know](mailto:compn@ffmpeg.org).
This filter was a feature request of mine
[since 2013](https://trac.ffmpeg.org/ticket/2104).

### August 5th, 2019, FFmpeg 4.2 "Ada"

[FFmpeg 4.2 "Ada"](https://ffmpeg.org/download.html#release_4.2), a new
major release, is now available! Some of the highlights:
...
[FFmpeg 4.1 "al-Khwarizmi"](https://ffmpeg.org/download.html#release_4.1), a new
major release, is now available! Some of the highlights:
...
[FFmpeg 4.0 "Wu"](https://ffmpeg.org/download.html#release_4.0), a new
major release, is now available! Some of the highlights:
...
[FFmpeg 3.4 "Cantor"](https://ffmpeg.org/download.html#release_3.4), a new
major release, is now available! Some of the highlights:
...
[FFmpeg 3.3 "Hilbert"](https://ffmpeg.org/download.html#release_3.3), a new
major release, is now available! Some of the highlights:
...
JÃ¡n SebechlebskÃ½'s generic goal was to improve the tee muxer so it tolerated blocking IO and allowed transparent error recovery. During the design phase it turned out that this functionality called for a separate muxer, so JÃ¡n spent his summer working on the so-called FIFO muxer, gradually fixing issues all over the codebase. He succeeded in his task, and the FIFO muxer is now part of the main repository, alongside several other improvements he made in the process.
...
[FFmpeg 3.1.2](https://ffmpeg.org/download.html#release_3.1), a new point release from the 3.1 release branch, is now available!
...
[FFmpeg 3.1.1](https://ffmpeg.org/download.html#release_3.1), a new point release from the 3.1 release branch, is now available!
...
[FFmpeg 3.1 "Laplace"](https://ffmpeg.org/download.html#release_3.1), a new
major release, is now available! Some of the highlights:
...
FFmpeg has been accepted as a [Google Summer of Code](https://summerofcode.withgoogle.com/) open source organization. If you wish to
participate as a student see our [project ideas page](https://trac.ffmpeg.org/wiki/SponsoringPrograms/GSoC/2016).
...
[FFmpeg 3.0 "Einstein"](https://ffmpeg.org/download.html#release_3.0), a new
major release, is now available! Some of the highlights:

[The native FFmpeg AAC encoder has seen extensive improvements and is no longer considered experimental](https://ffmpeg.org#aac_encoder_stable)[Removed support for libvo-aacenc and libaacplus](https://ffmpeg.org#removing_external_aac_encoders)- Over 30 new filters have been added
...
- See the
[Changelog](https://git.videolan.org/?p=ffmpeg.git;a=blob_plain;f=Changelog;hb=n3.0)for a list of more updates
...
[stable](https://ffmpeg.org#aac_encoder_stable), it was known that libvo-aacenc
...
to [Kamedo2](http://d.hatena.ne.jp/kamedo2/) who does comparisons
...
feedback or breakage reports through our [bug tracker](https://trac.ffmpeg.org/).
...
MediaHub Ltd. is a Bulgarian IPTV platform and services provider which uses FFmpeg heavily since it started operating a year ago.

*"Donating to help keep FFmpeg online is our way of giving back to the community"*.
...
the [Google
Summer of Code](http://www.google-melange.com/gsoc/homepage/google/gsoc2015) Project. FFmpeg got a total of 8 assigned
projects, and 7 of them were successful.

We want to thank [Google](https://www.google.com), the
...
#### Browsing content on the server, mentee: Mariusz SzczepaÅczyk, mentor: Lukasz Marek
...
We published release ** 2.8** as new major version.
...
[changelog](https://raw.githubusercontent.com/FFmpeg/FFmpeg/release/2.8/Changelog)We recommend users, distributors and system integrators to upgrade unless they use current git master.
...
Days](https://www.videolan.org/videolan/events/vdd15/) in Paris in September: a neutral venue for the entire open source
...
After graciously hosting our projects ([FFmpeg](http://www.ffmpeg.org), [MPlayer](http://www.mplayerhq.hu)
and [rtmpdump](http://rtmpdump.mplayerhq.hu)) for 4 years, Arpi (our hoster) has informed us that we have to secure a new host somewhere else immediately.

If you want to host an open source project, please let us know, either on [ffmpeg-devel](http://ffmpeg.org/mailman/listinfo/ffmpeg-devel)
...
**for a list of note-worthy changes.**

[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=release/2.6)We recommend users, distributors and system integrators to upgrade unless they use current git master.

### March 4, 2015, Google Summer of Code

FFmpeg has been accepted as a [Google Summer of Code](http://www.google-melange.com/gsoc/homepage/google/gsoc2015) Project. If you wish to
participate as a student see our [project ideas page](https://trac.ffmpeg.org/wiki/SponsoringPrograms/GSoC/2015).
...
You can read the details [here](https://chemnitzer.linux-tage.de/2015/de/programm/beitrag/209).
...
[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=release/2.5)### October 10, 2014, FFmpeg is in Debian unstable again

We wanted you to know there are
[
FFmpeg packages in Debian unstable](https://packages.debian.org/search?keywords=ffmpeg&searchon=sourcenames&suite=unstable§ion=main) again. **A big thank-you
...
[Read the argumentation over at Debian.](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=763148)
...
a look at our [OPW wiki page](https://trac.ffmpeg.org/wiki/SponsoringPrograms/OPW/2014-12)
...
[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=release/2.4)### August 20, 2014, FFmpeg 2.3.3, 2.2.7, 1.2.8
...
[
Click&Pledge](https://co.clickandpledge.com/advanced/default.aspx?wid=56226) and selecting the "OPW" option. If you would like to
donate by money transfer or by check, please get in touch by
[e-mail](mailto:opw@ffmpeg.org) and we will get back to you
with instructions.
...
made by [db0](http://db0.fr). While this was initially motivated
...
[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=489d066)### July 3, 2014, FFmpeg and the Outreach Program For Women
...
[OPW](https://gnome.org/opw/) aims to "Help women (cis and trans)
...
We have set up an [email address](mailto:opw@ffmpeg.org) you can use
...
[security issue in the LZO implementation](http://blog.securitymouse.com/2014/06/raising-lazarus-20-year-old-bug-that.html), as well as several other bugs. See the git log for details.
...
[archive](https://lists.ffmpeg.org/pipermail/ffmpeg-user/2014-April/020968.html)
.

We encourage you to read up on
["OpenSSL heartbleed"](https://www.schneier.com/blog/archives/2014/04/heartbleed.html).
...
[RogÃ©rio Brito](http://cynic.cc/blog/), a Debian developer,
...
of the real FFmpeg! See Debian [ticket #729203](http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=729203)
for more details.
