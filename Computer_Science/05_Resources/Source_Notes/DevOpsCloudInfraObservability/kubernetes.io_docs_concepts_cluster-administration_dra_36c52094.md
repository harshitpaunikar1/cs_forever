Title: Good practices for Dynamic Resource Allocation as a Cluster Admin | Kubernetes
Mapped Topic: Kubernetes concepts and tutorials
Source URL: https://kubernetes.io/docs/concepts/cluster-administration/dra/
Source Type: official_docs
Trust Score: 98
Fetched At: 2026-04-17T07:11:29+00:00
...
Pods, and if the DRA driver is [drained](https://kubernetes.io/docs/reference/glossary/?all=true#term-drain) before Pods with claims have been deleted, it will not be
...
Control plane component [kube-scheduler](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-scheduler/) and the internal ResourceClaim controller
orchestrated by the component [kube-controller-manager](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-controller-manager/) do the
...
metricsThe following metrics look closely at the internal ResourceClaim controller
...
metricsThe following scheduler metrics are high level metrics aggregating performance
...
's performance in creating ResourceClaims from
...
metricsWhen a Pod bound to a node must have a ResourceClaim satisfied, kubelet calls
...
metrics.- DRA kubeletplugin gRPC NodePrepareResources operation: Observe
