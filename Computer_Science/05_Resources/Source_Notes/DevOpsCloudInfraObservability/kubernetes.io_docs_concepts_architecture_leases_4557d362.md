...
Source URL: https://kubernetes.io/docs/concepts/architecture/leases/
Source Type: official_docs
Trust Score: 98
Fetched At: 2026-04-17T07:11:05+00:00
...
(enabled by default)Starting in Kubernetes v1.26, each `kube-apiserver`
...
hostname used by kube-apiserver by checking the value of the `kubernetes.io/hostname`
...
[controller](https://kubernetes.io/docs/concepts/architecture/controller/) where a primary or leader member
