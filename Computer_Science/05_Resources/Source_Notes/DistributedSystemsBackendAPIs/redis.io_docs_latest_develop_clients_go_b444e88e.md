Title: go-redis guide (Go) | Docs
Mapped Topic: Caching and in-memory data structures
Source URL: https://redis.io/docs/latest/develop/clients/go/
Source Type: official_docs
Trust Score: 94
Fetched At: 2026-04-17T07:08:54+00:00
...
[ go-redis](https://github.com/redis/go-redis) is the

[Go](https://go.dev/)client for Redis. The sections below explain how to install

`go-redis`

and connect your application to a Redis database.`go-redis`
...
supports the last two Go versions. You can only use it from within
...
command to install `go-redis/v9`
...
Close the connection when you're done using a `Close()`
...
[GitHub repository](https://github.com/redis/go-redis).
