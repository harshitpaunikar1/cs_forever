Title: Debugging — The Linux Kernel  documentation
Mapped Topic: Kernel labs and lectures
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/lectures/debugging.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:25+00:00
Mapped From CSE.md Section: Part 2: C. Operating systems, Linux internals, kernel understanding

# Content

# Debugging[¶](https://linux-kernel-labs.github.io#debugging)
...
## Decoding an oops/panic[¶](https://linux-kernel-labs.github.io#decoding-an-oops-panic)
...
### Decoding an oops[¶](https://linux-kernel-labs.github.io#decoding-an-oops)
...
### gdb[¶](https://linux-kernel-labs.github.io#gdb)
...
### Kernel panic[¶](https://linux-kernel-labs.github.io#kernel-panic)
...
## List debugging[¶](https://linux-kernel-labs.github.io#list-debugging)
...
## Memory debugging[¶](https://linux-kernel-labs.github.io#memory-debugging)
...
### Slab debugging[¶](https://linux-kernel-labs.github.io#slab-debugging)
...
### DEBUG_PAGEALLOC[¶](https://linux-kernel-labs.github.io#debug-pagealloc)
...
### KASan[¶](https://linux-kernel-labs.github.io#kasan)
...
#### KASan vs DEBUG_PAGEALLOC[¶](https://linux-kernel-labs.github.io#kasan-vs-debug-pagealloc)

KASan is slower than DEBUG_PAGEALLOC, but KASan works on sub-page granularity level, so it able to find more bugs.

#### KASan vs SLUB_DEBUG[¶](https://linux-kernel-labs.github.io#kasan-vs-slub-debug)
...
### Kmemleak[¶](https://linux-kernel-labs.github.io#kmemleak)
...
## Lockdep checker[¶](https://linux-kernel-labs.github.io#lockdep-checker)
...
## Other tools[¶](https://linux-kernel-labs.github.io#other-tools)
