Title: Kernel Profiling — The Linux Kernel  documentation
Mapped Topic: Kernel labs and lectures
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/labs/kernel_profiling.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:20+00:00
Mapped From CSE.md Section: Part 2: C. Operating systems, Linux internals, kernel understanding

# Content

# Kernel Profiling[¶](https://linux-kernel-labs.github.io#kernel-profiling)
...
## Profiling Tools[¶](https://linux-kernel-labs.github.io#profiling-tools)
...
### perf[¶](https://linux-kernel-labs.github.io#perf)
...
- records function calls and stack traces based on tracing points defined by the user; It can also record specific function calls and their stack traces. The record is saved in a file, named`perf.data`
...
### ps[¶](https://linux-kernel-labs.github.io#ps)
...
### time[¶](https://linux-kernel-labs.github.io#time)
...
### top[¶](https://linux-kernel-labs.github.io#top)
...
## Profiling Methodology[¶](https://linux-kernel-labs.github.io#profiling-methodology)
...
binary from [this](http://swarm.cs.pub.ro/~sweisz/perf) link. Download the application in
...
on [curs.upb.ro platform](https://curs.upb.ro/2022/mod/feedbackadm/view.php?id=15292).
...
## 0. Demo: Profiling I/O Problems[¶](https://linux-kernel-labs.github.io#demo-profiling-i-o-problems)
...
in order to print the table header, and ```
-F
...
### 1. Investigating Reduced Responsiveness[¶](https://linux-kernel-labs.github.io#investigating-reduced-responsiveness)
...
spending most of its time. In order to do this, you can run either ```
perf
record
```
...
### 2. Launching New Threads[¶](https://linux-kernel-labs.github.io#launching-new-threads)
...
[¶](https://linux-kernel-labs.github.io#tuning-cp)
...
system call, and writing that buffer to the destination file using the`write()`
...
### 4. I/O Latency[¶](https://linux-kernel-labs.github.io#i-o-latency)
...
### 5. Bad ELF[¶](https://linux-kernel-labs.github.io#bad-elf)
...
We managed to build (as part of a [Unikraft](https://github.com/unikraft/unikraft) build) an ELF file that is valid when doing static analysis, but that can't be executed.
The file is `bad_elf`
...
, or, better yet [ftrace](https://jvns.ca/blog/2017/03/19/getting-started-with-ftrace/) to inspect the kernel function calls done by the program.
