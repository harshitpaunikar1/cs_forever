...
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/lectures/intro.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:27+00:00
...
## Basic operating systems terms and concepts[¶](https://linux-kernel-labs.github.io#basic-operating-systems-terms-and-concepts)

### User vs Kernel[¶](https://linux-kernel-labs.github.io#user-vs-kernel)
...
[[1]](https://linux-kernel-labs.github.io#hypervisor) control the CPU while code that runs in user mode has
...
### Typical operating system architecture[¶](https://linux-kernel-labs.github.io#typical-operating-system-architecture)
...
### Monolithic kernel[¶](https://linux-kernel-labs.github.io#monolithic-kernel)
...
### Micro kernel[¶](https://linux-kernel-labs.github.io#micro-kernel)
...
performance penalty [[2]](https://linux-kernel-labs.github.io#minix-vs-linux).

|

[https://lwn.net/Articles/220255/](https://lwn.net/Articles/220255/)### Micro-kernels vs monolithic kernels[¶](https://linux-kernel-labs.github.io#micro-kernels-vs-monolithic-kernels)
...
### Address space[¶](https://linux-kernel-labs.github.io#address-space)
...
### User and kernel sharing the virtual address space[¶](https://linux-kernel-labs.github.io#user-and-kernel-sharing-the-virtual-address-space)
...
### Execution contexts[¶](https://linux-kernel-labs.github.io#execution-contexts)
...
### Multi-tasking[¶](https://linux-kernel-labs.github.io#multi-tasking)
...
### Preemptive kernel[¶](https://linux-kernel-labs.github.io#preemptive-kernel)
...
### Pageable kernel memory[¶](https://linux-kernel-labs.github.io#pageable-kernel-memory)
...
### Kernel stack[¶](https://linux-kernel-labs.github.io#kernel-stack)
...
### Portability[¶](https://linux-kernel-labs.github.io#portability)
...
### Asymmetric MultiProcessing (ASMP)[¶](https://linux-kernel-labs.github.io#asymmetric-multiprocessing-asmp)
...
### Symmetric MultiProcessing (SMP)[¶](https://linux-kernel-labs.github.io#symmetric-multiprocessing-smp)
...
### CPU Scalability[¶](https://linux-kernel-labs.github.io#cpu-scalability)
...
## Overview of the Linux kernel[¶](https://linux-kernel-labs.github.io#overview-of-the-linux-kernel)

### Linux development model[¶](https://linux-kernel-labs.github.io#linux-development-model)
...
### Maintainer hierarchy[¶](https://linux-kernel-labs.github.io#maintainer-hierarchy)
...
### Linux source code layout[¶](https://linux-kernel-labs.github.io#linux-source-code-layout)
...
### Linux kernel architecture[¶](https://linux-kernel-labs.github.io#linux-kernel-architecture)

#### arch[¶](https://linux-kernel-labs.github.io#arch)
...
#### Device drivers[¶](https://linux-kernel-labs.github.io#device-drivers)
...
#### Process management[¶](https://linux-kernel-labs.github.io#process-management)
...
implementing processes or threads, instead there is a ```
struct
task_struct
```
...
#### Memory management[¶](https://linux-kernel-labs.github.io#memory-management)
...
#### Block I/O management[¶](https://linux-kernel-labs.github.io#block-i-o-management)
...
#### Virtual Filesystem Switch[¶](https://linux-kernel-labs.github.io#virtual-filesystem-switch)
...
#### Networking stack[¶](https://linux-kernel-labs.github.io#networking-stack)

#### Linux Security Modules[¶](https://linux-kernel-labs.github.io#linux-security-modules)
