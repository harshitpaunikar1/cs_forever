Title: Address Space — The Linux Kernel  documentation
Mapped Topic: Kernel labs and lectures
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/lectures/address-space.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:23+00:00
...
## x86 MMU[¶](https://linux-kernel-labs.github.io#x86-mmu)
...
### Selectors[¶](https://linux-kernel-labs.github.io#selectors)
...
### Segment descriptor[¶](https://linux-kernel-labs.github.io#segment-descriptor)
...
### Segmentation in Linux[¶](https://linux-kernel-labs.github.io#segmentation-in-linux)
...
### x86 Paging[¶](https://linux-kernel-labs.github.io#x86-paging)
...
### Page tables[¶](https://linux-kernel-labs.github.io#page-tables)
...
### Linux paging[¶](https://linux-kernel-labs.github.io#linux-paging)
...
### Translation Look-aside Buffer[¶](https://linux-kernel-labs.github.io#translation-look-aside-buffer)
...
## Linux address space[¶](https://linux-kernel-labs.github.io#linux-address-space)

### Address space options for 32bit systems[¶](https://linux-kernel-labs.github.io#address-space-options-for-32bit-systems)
...
### Linear mappings[¶](https://linux-kernel-labs.github.io#linear-mappings)
...
### Highmem[¶](https://linux-kernel-labs.github.io#highmem)
...
is used to allocate non-contiguous system memory
...
is used to map device memory or device registers
into the kernel address space. It maps a contiguous physical memory
range into highmem with page caching disabled.

### Fixed-mapped linear addresses[¶](https://linux-kernel-labs.github.io#fixed-mapped-linear-addresses)
...
### Temporary mappings[¶](https://linux-kernel-labs.github.io#temporary-mappings)
...
atomic kmap section, defined in between the `kmap_atomic()`

and
`kunmap_atomic()`

can not be preempted. That is why these are
...
### Permanent mappings[¶](https://linux-kernel-labs.github.io#permanent-mappings)
