Title: Kernel Development on ARM — The Linux Kernel  documentation
Mapped Topic: Kernel labs and lectures
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/labs/arm_kernel_development.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:06+00:00
Mapped From CSE.md Section: Part 2: C. Operating systems, Linux internals, kernel understanding

# Content

# Kernel Development on ARM[¶](https://linux-kernel-labs.github.io#kernel-development-on-arm)
...
## System on a Chip[¶](https://linux-kernel-labs.github.io#system-on-a-chip)
...
We will refer as a reference platform at NXP's [i.MX6UL](https://linux-kernel-labs.github.io/imx6ul) platform, but in general all SoC's contain the following building blocks:
...
## Board Support package[¶](https://linux-kernel-labs.github.io#board-support-package)
...
## Toolchain[¶](https://linux-kernel-labs.github.io#toolchain)
...
We can build our own cross compiler from scratch using [https://crosstool-ng.github.io/](https://crosstool-ng.github.io/) or we can install one
...
### Compiling the Linux kernel on ARM[¶](https://linux-kernel-labs.github.io#compiling-the-linux-kernel-on-arm)
...
## Linux kernel image[¶](https://linux-kernel-labs.github.io#linux-kernel-image)
...
, for arm32`arch/arm64/boot/Image`
...
## Rootfs[¶](https://linux-kernel-labs.github.io#rootfs)
...
## Device tree[¶](https://linux-kernel-labs.github.io#device-tree)
...
, is an identifier used to reference the node from other places`name`
...
## Qemu[¶](https://linux-kernel-labs.github.io#qemu)
...
. See [Qemu](https://linux-kernel-labs.github.io#qemu) section for more details.

### 1. Boot[¶](https://linux-kernel-labs.github.io#boot)
...
Review [Compiling the Linux kernel on ARM](https://linux-kernel-labs.github.io#compiling-the-linux-kernel-on-arm) section.

Successful compilation will result in the following binaries:

`arch/arm/boot/Image`

, kernel image compiled for ARM`arch/arm/boot/dts/imx6ul-14x14-evk.dtb`

, device tree blob for`i.MX6UL`

board

Review [Rootfs](https://linux-kernel-labs.github.io#rootfs) section and download `core-image-minimal-qemuarm.ext4`
...
### 2. CPU information[¶](https://linux-kernel-labs.github.io#cpu-information)
...
device tree node and look for`operating-points`
...
### 3. I/O memory[¶](https://linux-kernel-labs.github.io#i-o-memory)
...
, look for`memory@80000000`

node in`arch/arm/boot/dts/imx6ul-14x14-evk.dtsi`

. What's the size of the System RAM?`GPIO1`

, look for`gpio@209c000`

node in`arch/arm/boot/dts/imx6ul.dtsi`

. What's the size of the I/O space for this device?`I2C1`

, look for`i2c@21a0000`

node in`arch/arm/boot/dts/imx6ul.dtsi`

. What's the size of the I/O spaces for this device?

### 4. Hello World[¶](https://linux-kernel-labs.github.io#hello-world)
...
### 5. Simple device[¶](https://linux-kernel-labs.github.io#simple-device)
