...
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/lectures/interrupts.html
...
# Interrupts[¶](https://linux-kernel-labs.github.io#interrupts)
...
## What is an interrupt?[¶](https://linux-kernel-labs.github.io#what-is-an-interrupt)
...
**synchronous**, generated by executing an instruction**asynchronous**, generated by an external event**maskable**- can be ignored
...
### Exceptions[¶](https://linux-kernel-labs.github.io#exceptions)
...
### Quiz: interrupt terminology[¶](https://linux-kernel-labs.github.io#quiz-interrupt-terminology)
...
## Hardware Concepts[¶](https://linux-kernel-labs.github.io#hardware-concepts)

### Programmable Interrupt Controller[¶](https://linux-kernel-labs.github.io#programmable-interrupt-controller)
...
### Interrupt controllers in SMP systems[¶](https://linux-kernel-labs.github.io#interrupt-controllers-in-smp-systems)
...
### Interrupt Control[¶](https://linux-kernel-labs.github.io#interrupt-control)
...
### Interrupt priorities[¶](https://linux-kernel-labs.github.io#interrupt-priorities)
...
### Quiz: hardware concepts[¶](https://linux-kernel-labs.github.io#quiz-hardware-concepts)
...
## Interrupt handling on the x86 architecture[¶](https://linux-kernel-labs.github.io#interrupt-handling-on-the-x86-architecture)

This section will examine how interrupts are handled by the CPU on the x86 architecture.

### Interrupt Descriptor Table[¶](https://linux-kernel-labs.github.io#interrupt-descriptor-table)
...
### Interrupt handler address[¶](https://linux-kernel-labs.github.io#interrupt-handler-address)
...
### Stack of interrupt handler[¶](https://linux-kernel-labs.github.io#stack-of-interrupt-handler)
...
### Handling an interrupt request[¶](https://linux-kernel-labs.github.io#handling-an-interrupt-request)
...
### Returning from an interrupt handler[¶](https://linux-kernel-labs.github.io#returning-from-an-interrupt-handler)
...
### Quiz: x86 interrupt handling[¶](https://linux-kernel-labs.github.io#quiz-x86-interrupt-handling)
...
## Interrupt handling in Linux[¶](https://linux-kernel-labs.github.io#interrupt-handling-in-linux)
...
### Nested interrupts and exceptions[¶](https://linux-kernel-labs.github.io#nested-interrupts-and-exceptions)
...
### Interrupt context[¶](https://linux-kernel-labs.github.io#interrupt-context)
...
### Deferrable actions[¶](https://linux-kernel-labs.github.io#deferrable-actions)
...
### Soft IRQs[¶](https://linux-kernel-labs.github.io#soft-irqs)
...
running soft irqs for more than `MAX_SOFTIRQ_TIME`

or rescheduling for
more than `MAX_SOFTIRQ_RESTART`
...
### Packet flood example[¶](https://linux-kernel-labs.github.io#packet-flood-example)
...
### Deferrable actions summary[¶](https://linux-kernel-labs.github.io#deferrable-actions-summary)
...
### Quiz: Linux interrupt handling[¶](https://linux-kernel-labs.github.io#quiz-linux-interrupt-handling)
