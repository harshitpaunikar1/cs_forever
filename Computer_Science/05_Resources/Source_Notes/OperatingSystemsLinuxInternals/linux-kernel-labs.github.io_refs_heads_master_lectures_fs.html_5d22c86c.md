Title: Filesystem Management — The Linux Kernel  documentation
Mapped Topic: Kernel labs and lectures
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/lectures/fs.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:26+00:00
Mapped From CSE.md Section: Part 2: C. Operating systems, Linux internals, kernel understanding

# Content

# Filesystem Management[¶](https://linux-kernel-labs.github.io#filesystem-management)
...
## Filesystem Abstractions[¶](https://linux-kernel-labs.github.io#filesystem-abstractions)
...
## Filesystem Operations[¶](https://linux-kernel-labs.github.io#filesystem-operations)
...
### Mounting a filesystem[¶](https://linux-kernel-labs.github.io#mounting-a-filesystem)
...
### Opening a file[¶](https://linux-kernel-labs.github.io#opening-a-file)
...
- Create a new
*file*that points to the last*dentry* - Find a free entry in the file descriptor table and set it to
*file*

### Querying file attributes[¶](https://linux-kernel-labs.github.io#querying-file-attributes)

A summary of a typical implementation is presented below:

### Reading data from a file[¶](https://linux-kernel-labs.github.io#reading-data-from-a-file)
...
### Writing data to a file[¶](https://linux-kernel-labs.github.io#writing-data-to-a-file)
...
### Closing a file[¶](https://linux-kernel-labs.github.io#closing-a-file)
...
- When the counter reaches 0 free
*file*

### Directories[¶](https://linux-kernel-labs.github.io#directories)

Directories are special files which contain one or more dentries.

### Creating a file[¶](https://linux-kernel-labs.github.io#creating-a-file)
...
### Deleting a file[¶](https://linux-kernel-labs.github.io#deleting-a-file)
...
## Linux Virtual File System[¶](https://linux-kernel-labs.github.io#linux-virtual-file-system)
...
- reads the filesystem statistics (e.g. total number of inode, free number of inodes, total number of blocks, free number of blocks)`write_super()`

- updates the superblock information on storage (e.g. updating the number of free inode or data blocks)`put_super()`

- free any data associated with the filsystem instance, called when unmounting a filesystem
...
### The Inode Cache[¶](https://linux-kernel-labs.github.io#the-inode-cache)
...
### The Dentry Cache[¶](https://linux-kernel-labs.github.io#the-dentry-cache)

- State:
- Used –
*d_inode*is valid and the*dentry*object is in use - Unused –
*d_inode*is valid but the dentry object is not in use - Negative –
*d_inode*is not valid; the inode was not yet loaded or the file was erased
...
### The Page Cache[¶](https://linux-kernel-labs.github.io#the-page-cache)

- Caches file data and not block device data
- Uses the
`struct address_space`

to translate file offsets to block offsets - Used for both read / write and mmap
- Uses a radix tree
