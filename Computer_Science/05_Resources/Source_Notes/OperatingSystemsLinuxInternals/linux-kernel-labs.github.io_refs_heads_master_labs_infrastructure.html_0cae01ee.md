Title: Infrastructure — The Linux Kernel  documentation
Mapped Topic: Kernel labs and lectures
Source URL: https://linux-kernel-labs.github.io/refs/heads/master/labs/infrastructure.html
Source Type: official_course_material
Trust Score: 95
Fetched At: 2026-04-17T07:06:15+00:00
Mapped From CSE.md Section: Part 2: C. Operating systems, Linux internals, kernel understanding

# Content

# Infrastructure[¶](https://linux-kernel-labs.github.io#infrastructure)
...
The **copy** target will fail if the VM is
